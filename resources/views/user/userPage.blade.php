...
@section('content')
                   ...
                   <div class="col-md-4 mb-5 hover-overlay  table-hover">
                       <div class="card h-100">
                           ...
                           <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                               <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="{{ route("user#userMoviedetail",$items->movie_id) }}">Go Detail</a></div>
                           </div>
                       </div>
                   </div>
                   @endforeach
    ...
    <div class="text-center d-flex justify-content-center align-items-center" id="contact">
        ...
        <div class="col-lg-4 border shadow-sm ps-5 pt-5 pe-5 pb-2 mb-5">
